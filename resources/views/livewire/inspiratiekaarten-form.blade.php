<div class="container mx-auto my-12">
    <h2 class="relative max-w-max mx-auto text-3xl uppercase !font-vpc900 md:text-4xl text-center">
        een vraag stellen
        <span class="absolute left-0 w-full h-3 -z-10 bottom-2 bg-theme-yellow"></span>
    </h2>
    <div>
        <form wire:submit.prevent="save" class="flex flex-col max-w-3xl gap-6 px-4 mx-auto mt-8 !font-vp600 text-xl">
            ...
            @if (session('success'))
                <p class="text-xl text-green-600">{{ session('success') }}</p>
            @endif
        </form>
    </div>
</div>
